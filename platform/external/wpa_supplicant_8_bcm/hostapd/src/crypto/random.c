...
int random_pool_ready(void)
{
     ...
     *
     * There may not be enough data available at /dev/random.
     * This situation makes this function return error. Hence, system turns on hotspot fail.
...
//MTD_CONN_EC_Tapioca_ICS-01320*[
    ...
    //There is no special reason to read 20 times. Just a decision.
    for (i = 0 ; i < 20 ; i++) {
        ...
        wpa_printf(MSG_INFO, "random: Got %u/%u bytes from "
