...
struct s5k5cag_i2c_reg_conf s5k5cag_arm_go_settings[] = {
    {0xFCFC, 0xD000},
    {0x0010, 0x0001},//Reset
...
struct s5k5cag_i2c_reg_conf s5k5cag_T_P_settings[] = {
    {0x0028, 0x7000},
    {0x002A, 0x2CF8},
    {0x0F12, 0xB570},
    {0x0F12, 0x4927},
...
struct s5k5cag_i2c_reg_conf s5k5cag_analog_settings[] = {
    {0x002A, 0x021A},
    {0x0F12, 0x0000},
    {0x002A, 0x157A},
    {0x0F12, 0x0001},
...
struct s5k5cag_i2c_reg_conf s5k5cag_3a_settings[] = {
	//================================================================================================
	// SET GAS
	//================================================================================================
	// GAS alpha
...
struct s5k5cag_i2c_reg_conf s5k5cag_clk_settings[] = {
    {0x002A, 0x01CC},
...
struct s5k5cag_i2c_reg_conf s5k5cag_fps_settings[] = {
...
struct s5k5cag_i2c_reg_conf s5k5cag_prev_settings[] = {
...
struct s5k5cag_i2c_reg_conf s5k5cag_recommend_settings[] = {
    {0x002A, 0x023C},
...
struct s5k5cag_i2c_reg_conf s5k5cag_snap_settings[] = {
    {0x002A, 0x035C},
...
struct s5k5cag_i2c_reg_conf s5k5cag_prev_to_snap[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0224},
    {0x0f12, 0x0001},
...
struct s5k5cag_i2c_reg_conf s5k5cag_snap_to_prev[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0224},
    {0x0f12, 0x0000},
...
struct s5k5cag_i2c_reg_conf s5k5cag_spot_settings[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0F7E},	
...
struct s5k5cag_i2c_reg_conf s5k5cag_center_settings[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0F7E},	
...
struct s5k5cag_i2c_reg_conf s5k5cag_multi_settings[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0F7E},	
...
struct s5k5cag_i2c_reg_conf s5k5cag_sport_settings[] = {
    {0x0028, 0x7000},
...
struct s5k5cag_i2c_reg_conf s5k5cag_sport_off_settings[] = {
    {0x0028,  0x7000},
...
struct s5k5cag_i2c_reg_conf s5k5cag_bench_snow_settings[] = {
...
struct s5k5cag_i2c_reg_conf s5k5cag_night_0_settings[] = {
    {0x0028,  0x7000}, 
    {0x002A,  0x023C},  
    {0x0F12,  0x0002},
    {0x0F12,  0x0001},  
...
struct s5k5cag_i2c_reg_conf s5k5cag_night_1_settings[] = {
    {0x0028,  0xd000},                        
    {0x002a,  0xb0a0},            
    {0x0F12,  0x0000},  	
};

struct s5k5cag_i2c_reg_conf s5k5cag_night_off_0_settings[] = {
    {0x0028,  0x7000}, 
    {0x002A,  0x023C},  
    {0x0F12,  0x0000},
    {0x0F12,  0x0001},  
...
struct s5k5cag_i2c_reg_conf s5k5cag_night_off_1_settings[] = {
    {0x0028,  0xd000},                        
    {0x002a,  0xb0a0},            
    {0x0F12,  0x0000},  	
};

struct s5k5cag_i2c_reg_conf s5k5cag_auto_scene_settings[] = {
    {0x0028, 0x7000}, //For Scene//
    {0x002A, 0x020C},
...
struct s5k5cag_reg s5k5cag_regs = {
       .reg_arm_go = &s5k5cag_arm_go_settings[0],
	.reg_arn_go_size = ARRAY_SIZE(s5k5cag_arm_go_settings),
	
	.reg_T_P = &s5k5cag_T_P_settings[0],
	.reg_T_P_size = ARRAY_SIZE(s5k5cag_T_P_settings),
	
	.reg_analog = &s5k5cag_analog_settings[0],
	.reg_analog_size = ARRAY_SIZE(s5k5cag_analog_settings),
	
	.reg_clk = &s5k5cag_clk_settings[0],
	.reg_clk_size = ARRAY_SIZE(s5k5cag_clk_settings),
	
	.reg_3a = &s5k5cag_3a_settings[0],
	.reg_3a_size = ARRAY_SIZE(s5k5cag_3a_settings),
	
       .reg_fps = &s5k5cag_fps_settings[0],
       .reg_fps_size = ARRAY_SIZE(s5k5cag_fps_settings),

	.reg_prev = &s5k5cag_prev_settings[0],
	.reg_prev_size = ARRAY_SIZE(s5k5cag_prev_settings),
	
	.reg_snap = &s5k5cag_snap_settings[0],
	.reg_snap_size = ARRAY_SIZE(s5k5cag_snap_settings),
	
	.reg_settings = &s5k5cag_recommend_settings[0],
	.reg_size = ARRAY_SIZE(s5k5cag_recommend_settings),

	.reg_prev_to_snap = &s5k5cag_prev_to_snap[0],
	.reg_prev_to_snap_size = ARRAY_SIZE(s5k5cag_prev_to_snap),
	
	.reg_snap_to_prev = &s5k5cag_snap_to_prev[0],
	.reg_snap_to_prev_size = ARRAY_SIZE(s5k5cag_snap_to_prev),
	
	//AE_Meter
	.reg_sopt_meter = &s5k5cag_spot_settings[0],
	.reg_sopt_meter_size = ARRAY_SIZE(s5k5cag_spot_settings),
	
	.reg_center_meter = &s5k5cag_center_settings[0],
	.reg_center_meter_size = ARRAY_SIZE(s5k5cag_center_settings),
	
	.reg_multi_meter = &s5k5cag_multi_settings[0],
	.reg_multi_meter_size = ARRAY_SIZE(s5k5cag_multi_settings),

	 //Scene
	.reg_sport = &s5k5cag_sport_settings[0],
	.reg_sport_size = ARRAY_SIZE(s5k5cag_sport_settings),

       .reg_sport_off = &s5k5cag_sport_off_settings[0],
	.reg_sport_off_size = ARRAY_SIZE(s5k5cag_sport_off_settings),   
	
	.reg_bench_snow = &s5k5cag_bench_snow_settings[0],
	.reg_bench_snow_size = ARRAY_SIZE(s5k5cag_bench_snow_settings),

	/* FIH-SW3-MM-UW-tuning0409-00+*/    
	.reg_night_0 = &s5k5cag_night_0_settings[0],
	.reg_night_0_size = ARRAY_SIZE(s5k5cag_night_0_settings),
 
	.reg_night_1 = &s5k5cag_night_1_settings[0],
	.reg_night_1_size = ARRAY_SIZE(s5k5cag_night_1_settings),
	/* FIH-SW3-MM-UW-tuning0409-00-*/

	.reg_night_off_0 = &s5k5cag_night_off_0_settings[0],
	.reg_night_off_0_size = ARRAY_SIZE(s5k5cag_night_off_0_settings),

	.reg_night_off_1 = &s5k5cag_night_off_1_settings[0],
	.reg_night_off_1_size = ARRAY_SIZE(s5k5cag_night_off_1_settings),   

	.reg_auto_scene = &s5k5cag_auto_scene_settings[0],
	.reg_auto_scene_size = ARRAY_SIZE(s5k5cag_auto_scene_settings),
};
