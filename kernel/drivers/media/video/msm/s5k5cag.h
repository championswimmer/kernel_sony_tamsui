...
struct s5k5cag_reg {
	/*const struct s5k5cag_i2c_reg_conf *reg_mipi;
	const unsigned short reg_mipi_size;
	const struct s5k5cag_i2c_reg_conf *reg_settings;
	const unsigned short reg_size;
	const struct s5k5cag_i2c_reg_conf *reg_pll_p;
	const unsigned short reg_pll_p_size;
	const struct s5k5cag_i2c_reg_conf *reg_pll_s;
	const unsigned short reg_pll_s_size;
	const struct s5k5cag_i2c_reg_conf *reg_prev;
	const unsigned short reg_prev_size;
	const struct s5k5cag_i2c_reg_conf *reg_snap;
	const unsigned short reg_snap_size;*/
    
	const struct s5k5cag_i2c_reg_conf *reg_arm_go;
	const unsigned short reg_arn_go_size;
	const struct s5k5cag_i2c_reg_conf *reg_settings;
	const unsigned short reg_size;
	const struct s5k5cag_i2c_reg_conf *reg_T_P;
	const unsigned short reg_T_P_size;
	const struct s5k5cag_i2c_reg_conf *reg_analog;
	const unsigned short reg_analog_size;
	const struct s5k5cag_i2c_reg_conf *reg_3a;
	const unsigned short reg_3a_size;
	const struct s5k5cag_i2c_reg_conf *reg_clk;
	const unsigned short reg_clk_size;
	const struct s5k5cag_i2c_reg_conf *reg_fps;
	const unsigned short reg_fps_size;
	const struct s5k5cag_i2c_reg_conf *reg_prev;
	const unsigned short reg_prev_size;
	const struct s5k5cag_i2c_reg_conf *reg_snap;
	const unsigned short reg_snap_size;
	const struct s5k5cag_i2c_reg_conf *reg_prev_to_snap;
	const unsigned short reg_prev_to_snap_size;
	const struct s5k5cag_i2c_reg_conf *reg_snap_to_prev;
	const unsigned short reg_snap_to_prev_size;
	
	const struct s5k5cag_i2c_reg_conf *reg_sopt_meter;
	const unsigned short reg_sopt_meter_size;
	const struct s5k5cag_i2c_reg_conf *reg_center_meter;
	const unsigned short reg_center_meter_size;
	const struct s5k5cag_i2c_reg_conf *reg_multi_meter;
	const unsigned short reg_multi_meter_size;

	const struct s5k5cag_i2c_reg_conf *reg_sport;
	const unsigned short reg_sport_size;
       const struct s5k5cag_i2c_reg_conf *reg_sport_off;
	const unsigned short reg_sport_off_size;
	const struct s5k5cag_i2c_reg_conf *reg_bench_snow;
	const unsigned short reg_bench_snow_size;
	/* FIH-SW3-MM-UW-tuning0409-00+*/
	const struct s5k5cag_i2c_reg_conf *reg_night_0;
	const unsigned short reg_night_0_size;
	const struct s5k5cag_i2c_reg_conf *reg_night_1;
	const unsigned short reg_night_1_size;
	/* FIH-SW3-MM-UW-tuning0409-00-*/
	const struct s5k5cag_i2c_reg_conf *reg_night_off_0;
	const unsigned short reg_night_off_0_size;
	const struct s5k5cag_i2c_reg_conf *reg_night_off_1;
	const unsigned short reg_night_off_1_size;
	const struct s5k5cag_i2c_reg_conf *reg_auto_scene;
