/* drivers/input/sensors/akm8975.c - akm8975 compass driver
 *
...
int akm8975_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if (pdata) {
		...
		pdata->gpio_init();	/* FIH-SW1-PERIPHERAL-FG-MSENSOR-00+ */
	} else {
	...
	/***** IRQ setup *****/
	client->irq = MSM_GPIO_TO_INT(GPIO_COMPASS_INT);	/* FIH-SW1-PERIPHERAL-FG-MSENSOR-00+ */
