...
static int __init mipi_cmd_novatek_fwvga_pt_init(void)
{
	int ret;
	...
	if (msm_fb_detect_client("mipi_cmd_novatek_fwvga"))
		return 0;
#endif
	...
	pinfo.mipi.data_lane1 = TRUE;  /* FIH-SW2-MM-NC-MIPI_TWO_LANE-00 */
...
module_init(mipi_cmd_novatek_fwvga_pt_init);
