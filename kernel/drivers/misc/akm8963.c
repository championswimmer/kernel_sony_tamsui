...
/*++ Huize - 20120329 Add for getting device information ++*/
static ssize_t akm8963_device_infor_read(struct file *file, struct kobject *kobj, struct bin_attribute *attr, char *buf, loff_t pos, size_t size)
{
	struct device_infor infor = {
		.name		= "AK8963 Magnetic Field Sensor",
...
static struct bin_attribute akm8963_bin_attributes[] = {
	...
	/*++ Huize - 20120329 Add for getting device information ++*/
	__BIN_ATTR(get_device_infor, 0440, sizeof(struct device_infor), NULL, akm8963_device_infor_read, NULL),
	/*-- Huize - 20120329 Add for getting device information --*/
	__BIN_ATTR_NULL
};
