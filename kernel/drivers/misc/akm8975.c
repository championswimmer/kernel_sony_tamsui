...
/*++ Huize - 20120329 Add for getting device information ++*/
	...
	int length)
{
  ...
  for(i=0;i<length;i++)
   {
     printk(KERN_INFO "RxData[%d]: data=%02x\n",i,rxData[i]);
   }
#endif
...
#if ARIMA_DEBUG			
	printk(KERN_INFO "TxData: len=%02x, addr=%02x data=%02x",length, txData[0], txData[1]);
#endif
	return 0;
}
	...
	struct i2c_client *client)
{
	...
	printk(KERN_INFO "AKM8975 Device ID 0x48.");
#endif	
	return err;
}
	...
	unsigned char mode)
{
	...
	int err;
#if ARIMA_DEBUG		
printk(KERN_INFO "AKM8975 compass driver: AKECS_Set_CNTL.");
#endif
	/* Busy check */
	...
	struct akm8975_data *akm)
{
	...
	int err;
	#if ARIMA_DEBUG
	printk(KERN_INFO "AKM8975 compass driver: AKECS_Set_PowerDown.");
	#endif
	/* Set measure mode */
	buffer[0] = AK8975_REG_CNTL;
	...
	unsigned char mode)
{
	int err;
	#if ARIMA_DEBUG
	printk(KERN_INFO "AKM8975 compass driver: AKECS_SetMode : Mode : %d",mode);
	#endif
	switch (mode) {
	...
	int size)
{
	int err;
	#if ARIMA_DEBUG
	printk(KERN_INFO "AKM8975 compass driver: AKECS_GetData.");
	#endif
	...
	#if ARIMA_DEBUG
	printk(KERN_INFO "%s: wait_event failed (%d).", __func__, err);
	#endif
	...
	#if ARIMA_DEBUG
	printk(KERN_INFO "%s: DRDY is not set.", __func__);
	#endif
	...
	int *rbuf)
{
	uint32_t ready;
	#if ARIMA_DEBUG
  	printk(KERN_INFO "AKM8975 compass driver: AKECS_SetYPR.");
	#endif
	...
	if (!rbuf[0]) {
		...
		#if ARIMA_DEBUG
		printk(KERN_INFO "AKM8975 compass driver: AKECS_SetYPR : Don't waste a time.");
		#endif
		return;
	}
...
{
	#if ARIMA_DEBUG
	printk(KERN_INFO "AKM8975 compass driver: AKECS_GetOpenStatus.");
	#endif
...
{
	#if ARIMA_DEBUG
	printk(KERN_INFO "AKM8975 compass driver: AKECS_GetCloseStatus.");
	#endif
	return wait_event_interruptible(
			akm->open_wq, (atomic_read(&akm->active) <= 0));
}
...
{
	#if ARIMA_DEBUG
	printk(KERN_INFO "AKM8975 compass driver: AKECS_Open.");
	#endif
...
{
	#if ARIMA_DEBUG
	printk(KERN_INFO "AKM8975 compass driver: AKECS_Release.");
	#endif
	return 0;
}
...
AKECS_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : CMD : %d",cmd);
	#endif
	switch (cmd) {
	case ECS_IOCTL_READ:
	case ECS_IOCTL_WRITE:
		if (argp == NULL) {
			...
			#if ARIMA_DEBUG	
			printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : invalid argument 1");
			#endif
			return -EINVAL;
		}
		if (copy_from_user(&i2c_buf, argp, sizeof(i2c_buf))) {
			...
			#if ARIMA_DEBUG	
			printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : copy_from_user failed 1");	
			#endif		
			return -EFAULT;
		}
		break;
	case ECS_IOCTL_SET_MODE:
		if (argp == NULL) {
			dev_err(&akm->i2c->dev, "invalid argument.");
			#if ARIMA_DEBUG	
			printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : invalid argument 2");
			#endif
			return -EINVAL;
		}
		if (copy_from_user(&mode, argp, sizeof(mode))) {
			dev_err(&akm->i2c->dev, "copy_from_user failed.");
			#if ARIMA_DEBUG	
			printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : copy_from_user failed 2");	
			#endif
			return -EFAULT;
		}
		break;
	case ECS_IOCTL_SET_YPR:
		if (argp == NULL) {
			dev_err(&akm->i2c->dev, "invalid argument.");
			#if ARIMA_DEBUG	
			printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : invalid argument 3");
			#endif  		
			return -EINVAL;
		}
		if (copy_from_user(&ypr_buf, argp, sizeof(ypr_buf))) {
			dev_err(&akm->i2c->dev, "copy_from_user failed.");
			#if ARIMA_DEBUG	
			printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : copy_from_user failed 3");	
			#endif
			return -EFAULT;
		}
	...
	case ECS_IOCTL_GET_ACCEL:
		...
		if (argp == NULL) {
			dev_err(&akm->i2c->dev, "invalid argument.");
			#if ARIMA_DEBUG	
			printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : invalid argument 4");	
			#endif
			return -EINVAL;
		}
		break;
	...
	case ECS_IOCTL_READ:
		...
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : IOCTL_READ");		
		#endif
	...
	case ECS_IOCTL_WRITE:
		...
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : IOCTL_WRITE");	
		#endif			
	...
	case ECS_IOCTL_SET_MODE:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : IOCTL_SET_MODE");		
		#endif	
	...
	case ECS_IOCTL_GETDATA:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : IOCTL_GETDATA");
		#endif			
	...
	case ECS_IOCTL_SET_YPR:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : IOCTL_SET_YPR");	
		#endif	
	...
	case ECS_IOCTL_GET_OPEN_STATUS:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : IOCTL_GET_OPEN_STATUS");	
		#endif	
	...
	case ECS_IOCTL_GET_CLOSE_STATUS:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : IOCTL_GET_CLOSE_STATUS");
		#endif		
	...
	case ECS_IOCTL_GET_DELAY:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : IOCTL_GET_DELAY");
		#endif
	...
	case ECS_IOCTL_GET_LAYOUT:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : IOCTL_GET_LAYOUT");
		#endif
	...
	case ECS_IOCTL_GET_ACCEL:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : IOCTL_GET_ACCEL");
		#endif
	...
	case ECS_IOCTL_READ:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : ECS_IOCTL_READ");
		#endif
	...
	case ECS_IOCTL_GETDATA:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : ECS_IOCTL_GETDATA");
		#endif
	...
	case ECS_IOCTL_GET_CLOSE_STATUS:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : ECS_IOCTL_GET_OPEN_STATUS");
		#endif
	...
	case ECS_IOCTL_GET_DELAY:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : ECS_IOCTL_GET_DELAY");
		#endif
	...
	case ECS_IOCTL_GET_LAYOUT:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : ECS_IOCTL_GET_LAYOUT");
		#endif
	...
	case ECS_IOCTL_GET_ACCEL:
		#if ARIMA_DEBUG	
		printk(KERN_INFO "AKM8975 compass driver: create_device_attributes : ECS_IOCTL_GET_ACCEL");
		#endif
	...
	struct device_attribute *attrs)
{
	...
	int err = 0;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: create_device_attributes");
	#endif 
	...
	struct device_attribute *attrs)
{
	int i;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: remove_device_attributes");
	#endif
	for (i = 0 ; NULL != attrs[i].attr.name ; ++i)
		device_remove_file(dev, &attrs[i]);
}
	...
	struct bin_attribute *attrs)
{
	...
	int err = 0;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: create_device_binary_attributes");
	#endif
	err = 0;
	...
	struct bin_attribute *attrs)
{
	int i;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: remove_device_binary_attributes");
	#endif
	for (i = 0 ; NULL != attrs[i].attr.name ; ++i)
		sysfs_remove_bin_file(kobj, &attrs[i]);
}
...
static bool get_value_as_int(char const *buf, size_t size, int *value)
{
	long tmp;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: get_value_as_int");
	#endif
	if (size == 0)
		return false;
...
static bool get_value_as_int64(char const *buf, size_t size, long long *value)
{
	long long tmp;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: get_value_as_int64");
	#endif
	if (size == 0)
		return false;
	...
	struct akm8975_data *akm)
{
	...
	mutex_unlock(&akm->val_mutex);
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_sysfs_update_active_status");
	#endif
	if (en == 0) {
		if (atomic_cmpxchg(&akm->active, 1, 0) == 1) {
			...
			#if ARIMA_DEBUG	
			printk(KERN_INFO "AKM8975 compass driver: akm8975_sysfs_update_active_status : Deactivated");
			#endif
		}
	} else {
		if (atomic_cmpxchg(&akm->active, 0, 1) == 0) {
			...
			#if ARIMA_DEBUG	
			printk(KERN_INFO "AKM8975 compass driver: akm8975_sysfs_update_active_status : Activated");
			#endif
		}
	}
	dev_dbg(&akm->i2c->dev,
	...
	struct akm8975_data *akm, char *buf, int pos)
{
	int flag;
	#if ARIMA_DEBUG	
  printk(KERN_INFO "AKM8975 compass driver: akm8975_sysfs_enable_show");
  #endif
	mutex_lock(&akm->val_mutex);
	...
	struct akm8975_data *akm, char const *buf, size_t count, int pos)
{
	int en = 0;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_sysfs_enable_store");
	#endif
	if (NULL == buf)
		return -EINVAL;
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_enable_acc_show");
	#endif
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_enable_acc_store");
	#endif
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_enable_mag_show");
	#endif
  return akm8975_sysfs_enable_show(
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_enable_mag_store");
	#endif
	return akm8975_sysfs_enable_store(
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_enable_ori_show");
	#endif
	return akm8975_sysfs_enable_show(
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_enable_ori_store");
	#endif
	return akm8975_sysfs_enable_store(
	...
	struct akm8975_data *akm, char *buf, int pos)
{
	int64_t val;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_sysfs_delay_show");
	#endif
	mutex_lock(&akm->val_mutex);
	val = akm->delay[pos];
	mutex_unlock(&akm->val_mutex);
	...
	struct akm8975_data *akm, char const *buf, size_t count, int pos)
{
	long long val = 0;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_sysfs_delay_store");
	#endif
	if (NULL == buf)
		return -EINVAL;
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_delay_acc_show");
	#endif
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_delay_acc_store");
	#endif
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_delay_mag_show");
	#endif
	return akm8975_sysfs_delay_show(
		dev_get_drvdata(dev), buf, MAG_DATA_FLAG);
}
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_delay_mag_store");
	#endif
	return akm8975_sysfs_delay_store(
		dev_get_drvdata(dev), buf, count, MAG_DATA_FLAG);
}
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_delay_ori_show.");
	#endif
	return akm8975_sysfs_delay_show(
		dev_get_drvdata(dev), buf, ORI_DATA_FLAG);
}
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_delay_ori_store.");
	#endif
	return akm8975_sysfs_delay_store(
		dev_get_drvdata(dev), buf, count, ORI_DATA_FLAG);
}
			...
			size_t size)
{
	...
	int16_t *accel_data;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_bin_accel_write.");
	#endif
	if (size == 0)
		return 0;
	...
	char const *buf, size_t count)
{
	...
	int mode = 0;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_mode_store.");
	#endif
	if (NULL == buf)
		return -EINVAL;
	...
	struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_bdata_show.");
	#endif
	mutex_lock(&akm->sensor_mutex);
	...
	struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	unsigned char asa[3];
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_asa_show.");
	#endif
...
/*++ Huize - 20120329 Add for getting device information ++*/
static ssize_t akm8975_device_infor_read(struct file *file, struct kobject *kobj, struct bin_attribute *attr, char *buf, loff_t pos, size_t size)
{
	struct device_infor infor = {
		.name		= "AK8975 Magnetic Field Sensor",
		.vendor		= "Asahi Kasei Microdevices",
		.maxRange	= 12288,
		.resolution = 0,
		.power		= 350,// ua
	};
	memcpy(buf, (char *) &infor, sizeof(struct device_infor));
	return sizeof(struct device_infor);
}
/*-- Huize - 20120329 Add for getting device information --*/
...
static struct bin_attribute akm8975_bin_attributes[] = {
	...
	/*++ Huize - 20120329 Add for getting device information ++*/
	__BIN_ATTR(get_device_infor, 0440, sizeof(struct device_infor), NULL, akm8975_device_infor_read, NULL),
	/*-- Huize - 20120329 Add for getting device information --*/
	__BIN_ATTR_NULL
};
...
/*++ Huize - 20120329 Add for naming general ++*/
static char const *const akm8975_device_name = "magnetic";
/*-- Huize - 20120329 Add for naming general --*/
...
static int create_sysfs_interfaces(struct akm8975_data *akm)
{
	...
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: create_sysfs_interfaces.");
	#endif
	if (NULL == akm)
		return -EINVAL;
...
{
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: remove_sysfs_interfaces.");
	#endif
	if (NULL == akm)
		return;
	...
	struct input_dev **input)
{
	int err = 0;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: akm8975_input_init.");
	#endif
...
static irqreturn_t akm8975_irq(int irq, void *handle)
{
	...
	int err;
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: irq.");
	#endif
...
static void akm8975_delayed_work(struct work_struct *work)
{
	...
	#if ARIMA_DEBUG		
	printk(KERN_INFO "AKM8975 compass driver: delayed_work.");
	#endif
...
int akm8975_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: probe.");
	#endif
...
static int akm8975_remove(struct i2c_client *client)
{
	...
	#if ARIMA_DEBUG	
	printk(KERN_INFO "AKM8975 compass driver: remove.");
	#endif
