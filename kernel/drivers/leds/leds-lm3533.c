					...
					const char *buf, size_t count)
{
	...
	if (rgb_brightness==634861)	// change sapphire theme display(temp)
	{
		rgb_brightness=6535423;
		led->lm3533_rgb_brightness = 6535423;
	}
	else if (rgb_brightness==634861)		// change silk theme display (must be changed)
	{
		rgb_brightness=14352383;
		led->lm3533_rgb_brightness = 14352383;
	}
	else if (rgb_brightness==4514265)	// change turquoise theme display
	{
		rgb_brightness=8388590;
		led->lm3533_rgb_brightness = 8388590;
	}
	else if (rgb_brightness==5166406)	// change emerald theme display
	{
		rgb_brightness=3342130;
		led->lm3533_rgb_brightness = 3342130;
	}
	else if (rgb_brightness==634861)	// change sapphire theme display
	{
		rgb_brightness=6535423;
		led->lm3533_rgb_brightness = 6535423;
	}
	else if (rgb_brightness==15578928)	// change gold theme display
	{
		rgb_brightness=15793934;
		led->lm3533_rgb_brightness = 15793934;
	}
	else if (rgb_brightness==15749018)	// change ruby theme display
	{
		rgb_brightness=16738740;
		led->lm3533_rgb_brightness = 16738740;
	}
	else if (rgb_brightness==14373626)	// change amethyst theme display
	{
