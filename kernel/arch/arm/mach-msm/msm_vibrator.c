...
/*++ Kevin Shiu - 20120403 save intensity using liked list ++*/ 
...
/*++ Huize - 20120403 add for improving performance and controling intensity ++*/
...
/*++ Huize - 20120403 modified for improving performance ++*/
                    ...
                    const char *buf, size_t count)
{
    ...
    printk(KERN_EMERG "%s , keep_time_data = %lu  \n",__func__,keep_time_data);
...
void __init msm_init_pmic_vibrator(void)
{
    ...
    /*++ Huize - 20120403 add for improving performance ++*/
