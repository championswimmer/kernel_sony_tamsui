...
#define DBG_IOCTL_CMD_SET_TCXOSD_DISPLAY_ON  _IOW(DEV_IOCTLID, 5, dbgcfg_ioctl_arg) /* FIH-SW-KERNEL-HC-TCXO_SD_DURING_DISPLAY_ON-01 */


//FIH-SW3-KERNEL-EL-remove_dummy-00-

/* Export kernel APIs */
int DbgCfgGetByBit(unsigned int bid,unsigned int *bvalue);

/* FIH-SW3-KERNEL-DL-Enable-Kconfig-00+[ */
...
enum
{
    ...
    /*FIH-SW3-KERNEL-TH-ForceRamdump-00+*/
    DEBUG_RAMDUMP_SAVE_PATH_CFG = 68,
    /*FIH-SW3-KERNEL-TH-ForceRamdump-00-*/
